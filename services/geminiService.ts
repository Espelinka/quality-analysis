...
function getAiClient(): GoogleGenAI {
  if (!ai) {
    ...
    // Vite replaces the env variable at build time. If the VITE_API_KEY variable is missing
    // in the build environment (like Vercel), it can become the literal string "undefined".
